        ...
        <div class="card card-default">
            ...
            <div class="card-body">
                <form class="form" method="post">
                    ...
                    <a target="_blank" href="/penjualan/struck" class="btn btn-success btn-lg btn-block">Cetak Struk</a> <a href="?menu=penjualan" class="btn btn-primary btn-lg btn-block">Kembali</a>
                </form>
            </div>
            <!--/panel content-->
        </div>
